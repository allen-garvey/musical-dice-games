        ...
        measures: [
            [  
                [
                    ...
                    'c2 e2',
                    'z/2 c/2c/2d/2 e/2e/2d/2c/2',
                    'c c/2d/2 e/2d/2e/2c/2',
                    'z/2 e/2g/2f/2 e/2g/2e/2c/2',
                ],
                [
                    'C,2 C2-',
                    'C E/2D/2 C C-',
            ...
            [  
                ...
                [
                    '-C B,/2A,/2 B, G,',
                    '-C/2C/2B,/2A,/2 C/2B,/2A,/2G,/2',
                    '-C B, E/2D/2C/2B,/2',
                    '-C B,/2A,/2 B,/2C/2D/2E/2',
                    '-C C B, E',
                    '-C C2 B,',
                    '-C B,/2A,/2 B,/2D/2B,/2G,/2',
                    '-C/2C/2B,/2A,/2 B,/2B,/2A,/2G,/2',
                    '-C C B, B,',
                ],
            ],
            [  
            ...
            [  
                [
                    '-f f e/2c/2a/2c/2',
                    '-f e/2d/2 e c',
                    '-f/2f/2e/2d/2 e/2e/2d/2c/2',
                    '-f e/2d/2 e/2g/2e/2c/2',
                    '-f f f/2e/2d/2c/2',
                    '-f3/2 f/2 e/2d/2e/2c/2',
                    '-f f2 e',
                    '-f f e a',
                    '-f/2B/2c/2d/2 e/2g/2f/2e/2',
                ],
                [
                    'G, C/2B,/2 C2-',
                    'G,/2G,/2C/2B,/2 C C-',
            ...
            [  
                [
                    ...
                    'd G g f',
                    'd g G f',
                    'd g/2a/2 g/2a/2f/2g/2',
                ],
                [
                    '-C B,/2A,/2 B,2',
                    '-C/2C/2B,/2A,/2 B,/2B,/2A,/2B,/2',
                    '-C2 B, A,/2B,/2',
                    '-C2 B,2',
                    '-C B,2 A,/2B,/2',
                    '-C C B, B,',
                    '-C/2A,/2B,/2C/2 B,/2C/2A,/2B,/2',
                    '-C B,- B,/2A,/2 B,',
                    '-C B,/2A,/2 B, A,/2B,/2',
                ],
            ],
